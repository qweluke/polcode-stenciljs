...
class BtnComponent$1 {
    ...
    render() {
        return (__chunk_1.h("div", { class: `polocode-input-wrapper` }, this.labelTxt && __chunk_1.h("label", { htmlFor: this.id }, this.labelTxt), __chunk_1.h("input", { type: "text", placeholder: this.placeholder, id: this.id, class: `polocode-input ${this.labelTxt ? 'with-label' : 'no-label'} `, value: this.value, required: this.required }), this.error && __chunk_1.h("div", { class: "error" }, this.error)));
    }
